...
from controllers.customerAccountController import find_all, login_customer, find_account, update_account, delete_account
...
customer_account_blueprint.route('/<int:id>', methods=['PUT'])(update_account)
customer_account_blueprint.route('/<int:id>', methods=['DELETE'])(delete_account)